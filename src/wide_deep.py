...
def build_model_columns():
    ...
    # To show an example of hashing:【只允许occupation有1000种取值】
    occupation = tf.feature_column.categorical_column_with_hash_bucket(
      'occupation', hash_bucket_size=1000)

    # Transformations.【分桶处理】
    ...
    deep_columns = [age,
                    ...
                    capital_loss,
                    hours_per_week,
                    tf.feature_column.indicator_column(workclass), # one-hot处理
    ...
    """
    按照paper的玩法：是将每个ont-hot后的categoricalfeature做成32维的embedding vector。
    """
